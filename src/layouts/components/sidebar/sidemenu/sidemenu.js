   ...
   render() {
      return (
         <SideMenu className="sidebar-content" toggleSidebarMenu={this.props.toggleSidebarMenu}>
            ...
            >
               <NavLink to="/masterdata/buycategory" exact className="item" activeclassname="active">
                  <span className="menu-item-text">Buy Category</span>
               </NavLink>
               <NavLink to="/masterdata/customisefeed" exact className="item" activeclassname="active">
                  <span className="menu-item-text">Customise Feed</span>
               </NavLink>
               <NavLink to="/masterdata/categorytypes" exact className="item" activeclassname="active">
                  <span className="menu-item-text">Category Types</span>
               </NavLink>
               <NavLink to="/masterdata/displaylanguage" exact className="item" activeclassname="active">
                  <span className="menu-item-text">Display Languages</span>
               </NavLink>
               <NavLink to="/masterdata/interests" exact className="item" activeclassname="active">
                  <span className="menu-item-text">Interest</span>
               </NavLink>
               ...
               <NavLink to="/masterdata/postcategory" exact className="item" activeclassname="active">
                  <span className="menu-item-text">Post Category</span>
               </NavLink>
            </SideMenu.MenuMultiItems>
            ...
            <SideMenu.MenuSingleItem badgeColor="danger">
               <NavLink to="/moderation" activeclassname="active">
                  <i className="menu-icon">
                     <Users size={18} />
                  </i>
                  <span className="menu-item-text">Moderation</span>
               </NavLink>
            </SideMenu.MenuSingleItem>
            <SideMenu.MenuMultiItems
               name="Feed Rules"
               ...
               collapsedSidebar={this.props.collapsedSidebar}
            >
               <NavLink to="/feedrules" exact className="item" activeclassname="active">
                  <span className="menu-item-text">Feed Rules</span>
               </NavLink>
               <NavLink to="/feedproperties" exact className="item" activeclassname="active">
                  <span className="menu-item-text">Feed Properties</span>
               </NavLink>
            </SideMenu.MenuMultiItems>
