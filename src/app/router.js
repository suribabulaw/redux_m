...
const LazyModeration = lazy(() => import("../views/moderation/moderation"));
const LazyBuyCategory = lazy(() => import("../views/masterdata/buycategory/buycategory"));
const LazyCustomiseFeed = lazy(() => import("../views/masterdata/customisefeed/customisefeed"));
const LazyCategoryTypes = lazy(() => import("../views/masterdata/categorytypes/categorytypes"));
const LazyDisplayLanguage = lazy(() => import("../views/masterdata/displaylanguage/displaylanguage"));
const LazyInterests = lazy(() => import("../views/masterdata/Interests/interests"));
const LazyOnboarding = lazy(() => import("../views/masterdata/onboarding/onboarding"));
const LazyPostCategory = lazy(() => import("../views/masterdata/postcategory/postcategory"));
const LazyFeedRules = lazy(() => import("../views/feedrules/feedrules"));
const LazyFeedProperties = lazy(() => import("../views/feedrules/feedproperties"));
         ...
         <BrowserRouter basename="/">
            <Switch>
               ...
               <MainLayoutRoutes
                  ...
                  render={matchprops => (
                     <Suspense fallback={<Spinner />}>
                        <LazyModeration {...matchprops} />
                     </Suspense>
                  )}
               />
               <MainLayoutRoutes
                  exact
                  path="/masterdata/buycategory"
                  render={matchprops => (
                     <Suspense fallback={<Spinner />}>
                        <LazyBuyCategory {...matchprops} />
                     </Suspense>
                  )}
               />
               <MainLayoutRoutes
                  exact
                  path="/masterdata/customisefeed"
                  render={matchprops => (
                     <Suspense fallback={<Spinner />}>
                        <LazyCustomiseFeed {...matchprops} />
                     </Suspense>
                  )}
               />
               <MainLayoutRoutes
                  exact
                  path="/masterdata/categorytypes"
                  render={matchprops => (
                     <Suspense fallback={<Spinner />}>
                        <LazyCategoryTypes {...matchprops} />
                     </Suspense>
                  )}
               />
               <MainLayoutRoutes
                  exact
                  path="/masterdata/displaylanguage"
                  render={matchprops => (
                     <Suspense fallback={<Spinner />}>
                        <LazyDisplayLanguage {...matchprops} />
                     </Suspense>
                  )}
               />
               <MainLayoutRoutes
                  exact
                  path="/masterdata/interests"
                  render={matchprops => (
                     <Suspense fallback={<Spinner />}>
                        <LazyInterests {...matchprops} />
                     </Suspense>
                  )}
               />
               <MainLayoutRoutes
               ...
               <MainLayoutRoutes
                  exact
                  path="/masterdata/postcategory"
                  render={matchprops => (
                     <Suspense fallback={<Spinner />}>
                        <LazyPostCategory {...matchprops} />
                     </Suspense>
                  )}
               />
               <MainLayoutRoutes
